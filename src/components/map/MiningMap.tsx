...
export default function MiningMap({ width = 1000, height = 500, onZoneClick, onZoneHover, className = '', viewMode = 'zone' }: MiningMapProps) {
  ...
  const getGalleryOpacity = () => {
    return viewMode === 'gallery' ? 1 : viewMode === 'level' ? 0.5 : 0.6;
  };
  ...
  return (
    ...
    >
      ...
      <path d="M 165 50 Q 175 250 165 450" stroke="#334155" strokeWidth="3" fill="none" opacity="0.5" />
      <path d="M 425 50 Q 435 250 425 450" stroke="#334155" strokeWidth="3" fill="none" opacity="0.5" />
      <path d="M 675 50 Q 685 250 675 450" stroke="#334155" strokeWidth="3" fill="none" opacity="0.5" />
      <path d="M 50 160 Q 400 145 750 160" stroke="#334155" strokeWidth="3" fill="none" opacity="0.5" />
      <path d="M 50 370 Q 400 355 750 370" stroke="#334155" strokeWidth="3" fill="none" opacity="0.5" />
      ...
      <g id="zone-a">
        ...
        />
        <text x="165" y="130" fill="#f97316" fontSize="16" fontWeight="bold" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE A') }}>
          ZONE A
        </text>
        <text x="165" y="150" fill="#fdba74" fontSize="11" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE A') }}>
          Extraction
        </text>
      </g>
      ...
      <g id="zone-b">
        ...
        />
        <text x="425" y="130" fill="#3b82f6" fontSize="16" fontWeight="bold" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE B') }}>
          ZONE B
        </text>
        <text x="425" y="150" fill="#60a5fa" fontSize="11" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE B') }}>
          Transport
        </text>
      </g>
      ...
      <g id="zone-c">
        ...
        />
        <text x="675" y="130" fill="#22c55e" fontSize="16" fontWeight="bold" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE C') }}>
          ZONE C
        </text>
        <text x="675" y="150" fill="#4ade80" fontSize="11" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE C') }}>
          Ventilation
        </text>
      </g>
      ...
      <g id="zone-d">
        ...
        />
        <text x="165" y="360" fill="#a855f7" fontSize="16" fontWeight="bold" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE D') }}>
          ZONE D
        </text>
        <text x="165" y="380" fill="#c084fc" fontSize="11" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE D') }}>
          Stockage
        </text>
      </g>
      ...
      <g id="zone-e">
        ...
        />
        <text x="425" y="400" fill="#ef4444" fontSize="16" fontWeight="bold" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE E') }}>
          ZONE E
        </text>
        <text x="425" y="420" fill="#f87171" fontSize="11" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE E') }}>
          Maintenance
        </text>
      </g>
      ...
      <g id="zone-f">
        ...
        />
        <text x="675" y="400" fill="#06b6d4" fontSize="16" fontWeight="bold" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE F') }}>
          ZONE F
        </text>
        <text x="675" y="420" fill="#22d3ee" fontSize="11" textAnchor="middle" style={{ opacity: getZoneOpacity('ZONE F') }}>
          Services
        </text>
      </g>
      ...
      <g transform="translate(50, 20)">
        <rect x="0" y="0" width="220" height="32" fill="#1e293b" stroke="#334155" strokeWidth="1.5" rx="6" />
        <text x="12" y="21" fill="#94a3b8" fontSize="12">Site: Mine Nord - Niveau -120m</text>
      </g>
    </svg>
  );
}
