      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#1e293b] rounded-xl border border-gray-700 p-8 shadow-xl">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 bg-[#0b1a2a] border border-gray-700 hover:border-gray-600 text-white py-2.5 rounded-lg transition-colors">
