...
const navItemKeys = [
  ...
  { icon: Cpu, labelKey: 'nav.watchLogs', id: 'watch-logs' },
  { icon: MapPin, labelKey: 'nav.gis-config', id: 'gis-config' },
  ...
  return (
    <div className="w-64 bg-[#1e293b] min-h-screen flex flex-col border-r border-gray-700">
      ...
      <div className="p-4 border-b border-gray-700">
        <img src={`/Logo-with-text.png`} alt="SupervisorApp" className="h-12 w-auto mx-auto" />
      </div>
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2 rounded transition-colors ${
                isActive ? 'bg-green-500 text-white' : 'text-gray-300 hover:bg-[#334155]'
              }`}
            >
              <Icon size={18} />
