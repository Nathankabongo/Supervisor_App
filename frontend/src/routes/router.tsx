...
const GisConfig = lazy<() => ReactElement>(() => import('pages/GisConfig'));
...
const WatchLogs = lazy<() => ReactElement>(() => import('pages/WatchLogs'));
...
const ForgotPassword = lazy<() => ReactElement>(
